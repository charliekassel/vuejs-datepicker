<template>
  <div :class="[calendarClass, 'vdp-datepicker__calendar']" v-show="showDayView" :style="calendarStyle" @mousedown.prevent>
    ...
    <div :class="isRtl ? 'flex-rtl' : ''">
      ...
      <template v-if="!showNeighborMonths && (blankDays > 0)">
...
export default {
  ...
  computed: {
     ...
     */
    blankDays () {
      return this.getBlankDays(this.pageDate)
    },
    /**
     * @return {Object[]}
     */
    days () {
      ...
      if (!this.showNeighborMonths) return currentMonthDates
